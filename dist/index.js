        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [2 /*return*/, config.videoBase + id];
                case 3:
                    error_1 = _a.sent();
                    throw new Error("Unable to fetch stream url: " + error_1);
...
function stdHandler(error, stdout, stderr) {
